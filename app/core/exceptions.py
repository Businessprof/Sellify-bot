class SellifyBaseException(Exception):
...
class InsufficientBalanceError(SellifyBaseException):
...
class OutOfStockError(SellifyBaseException):
...
class MembershipRequiredError(SellifyBaseException):
...
class UserBannedError(SellifyBaseException):
...
class FreebieCooldownError(SellifyBaseException):
...
QamifyBaseException = SellifyBaseException
